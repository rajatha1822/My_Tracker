...
public class SnacksAdapter extends BaseAdapter {
    ArrayList<Snacks> mSnacks;
    Context mContext;

    public SnacksAdapter(Context context,ArrayList<Snacks> mSnacks){
        mContext=context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Snacks mDisplayBF=(Snacks) getItem(position);
        View mView;
