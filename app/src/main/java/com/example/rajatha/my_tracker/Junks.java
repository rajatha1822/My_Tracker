...
public class Junks implements Parcelable {
    private int mID;
    ...
    public Junks(String mItem,String mCalories,String mQuantity,String mTCalories){
        this.mItem=mItem;
    ...
    public static final Parcelable.Creator<Junks> CREATOR = new Parcelable.Creator<Junks>() {
        @Override
        public Junks createFromParcel(Parcel source) {
            return new Junks(source);
        }

        @Override
        public Junks[] newArray(int size) {
            return new Junks[0];
        }
    };
}
