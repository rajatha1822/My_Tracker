...
public class Snacks implements Parcelable {
    ...
    public Snacks(String mItem,String mCalories,String mQuantity,String mTCalories){
        this.mItem=mItem;
    ...
    public static final Parcelable.Creator<Snacks> CREATOR = new Parcelable.Creator<Snacks>() {
        @Override
        public Snacks createFromParcel(Parcel source) {
            return new Snacks(source);
        }
