...
public class Drinks implements Parcelable {
    ...
    public Drinks(String mItem,String mCalories,String mQuantity,String mTCalories){
        this.mItem=mItem;
    ...
    public static final Parcelable.Creator<Drinks> CREATOR = new Parcelable.Creator<Drinks>() {
        @Override
